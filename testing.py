...
# adjacency = fusion.load_raw_match_matrix("./data/a3_match.pkl")
# artefact_indices = [
#     16,
#     41,
#     100,
...
#             coords_a, coords_b, scores_a, scores_b = adjacency[i][i + j]
#             # transforms.append(transform)
#             match_count_pres.append(len(coords_a))
...
#     # plt.plot(range(len(x_local_mean)), x_local_mean)
